package com.itranswarp.compiler.test.compiler;
...
import com.itranswarp.compiler.test.on.the.fly.BeanProxy;
import com.itranswarp.compiler.test.on.the.fly.User;

import cn.amlove.samdyn.Samdyn;
import junit.framework.TestCase;

public class JavaStringCompilerTest extends TestCase{
	...
	static final String SINGLE_JAVA = "/* a single java class to one file */  "
			+ "package on.the.fly;                                            "
			+ "import com.itranswarp.compiler.test.on.the.fly.*;                            "
	...
	public void testCompileSingleClass() throws Exception {
		...
		User user1 = Samdyn.fromSource("UserProxy.java", SINGLE_JAVA, "on.the.fly.UserProxy", com.itranswarp.compiler.test.on.the.fly.User.class);
		user1.setId("123");
		System.out.println(user1.getId());
		
//		User user1 = Samdyn.fromBytes(results.get("on.the.fly.UserProxy"), User.class);
//		System.out.println(Samdyn.toBytes(obj));
	}
